...
class MainActivity : AppCompatActivity() {
    ...
    fun UpdateQuestion() {
        ...
        if (selected == -1) {
            Toast.makeText(this, "Plese select answer", Toast.LENGTH_LONG).show()
            return
        }
            ...
            if (hasInternet) {
                ...
                try {
                    ...
                    for (i in 0..(resultArray.length() - 1)) {
                        ...
                        obj.Option1 = currentObject.getString("Question")
                        obj.Option2 = currentObject.getString("Question")
                        obj.Option3 = currentObject.getString("Question")
                        obj.Option4 = currentObject.getString("Question")
